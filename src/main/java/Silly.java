...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two string arguments, and concatenates them.
     *
     * @param first_string the string that will come first.
     * @param second_string the string that will go after first_string.
     */
    public Silly(String first_string, String second_string){
        StringBuilder new_sb = new StringBuilder();
        new_sb.append(first_string);
        new_sb.append(second_string);
        this.name = new_sb.toString();
    }
